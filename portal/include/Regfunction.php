...
if (isset($_POST['register'])){
    ...
    if($acct_password !== $confirm_password){
        ...
        if($stmt->rowCount() >0){
            ...
            $registered = "INSERT INTO users (firstname,lastname,acct_limit,limit_remain,acct_email,acct_password,acct_no,ssn,acct_balance,acct_type,acct_gender,marital_status,acct_currency,acct_phone,acct_occupation,country,state,acct_address,acct_dob,acct_cot,acct_imf,acct_tax,mgr_name,mgr_no,mgr_email,mgr_id,mgr_image) VALUES(:firstname,:lastname,:acct_limit,:limit_remain,:acct_email,:acct_password,:acct_no,:ssn,:acct_balance,:acct_type,:acct_gender,:marital_status,:acct_currency,:acct_phone,:acct_occupation,:country,:state,:acct_address,:acct_dob,:acct_cot,:acct_imf,:acct_tax,:mgr_name,:mgr_no,:mgr_email,:mgr_id,:mgr_image)";
