...
if(isset($_POST['regSubmit'])){
    ...
    if($acct_password !== $confirmPassword){
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $registered = "INSERT INTO users (firstname,lastname,acct_email,acct_password,acct_no,acct_type,acct_currency,acct_status,acct_phone,country) VALUES(:firstname,:lastname,:acct_email,:acct_password,:acct_no,:acct_type,:acct_currency,:acct_status,:acct_phone,:country)";
            ...
            if ($reg) {
                ...
                $APP_NAME = $pageTitle;
                $APP_URL = WEB_URL;
                $message = $sendMail->regMsgUser($fullName,$acct_no,$acct_status,$acct_email,$acct_phone,$acct_type,$acct_currency,$APP_NAME,$APP_URL);
                // User Email
                ...
                // Store the newly generated $acct_no in the session
    ...
    if (!empty($errors)) {
        foreach ($errors as $error) {
            notify_alert($error, 'danger', '3000', 'close');
        }
    }
}
?>
...
<section class="wizard-section" style="font-family: Arial, sans-serif;">
      <!--Google translate-->
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center">Create Your Bank Account</h2>
                    </div>
                    <div class="card-body">
                        <form action="" method="post" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wizard-required" id="acct_currency" name="acct_currency">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control wizard-required" id="acct_type" name="acct_type">
                                    <option selected="selected">Select Account Type</option>
                                    <option value="Savings">Savings Account</option>
                                    <option value="Current">Current Account</option>
                                    <!-- Add other account type options here -->
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control wizard-required" id="email" name="acct_email">
                            </div>
                            <div class="form-group">
                                <label for="phoneNumber">Phone Number*</label>
                                <input type="tel" class="form-control wizard-required" id="phoneNumber" name="phoneNumber">
                            </div>
                            <div class="form-group">
                            ...
                            <!--<div class="form-group">-->
                                <!--<label for="acct_pin">Account PIN (Number)*</label>-->
                                <!--<input type="text" class="form-control wizard-required" id="acct_pin" name="acct_pin">-->
                            <!--</div>-->
                            <div class="form-group text-center">
                                <button class="btn btn-primary" type="submit" name="regSubmit">Submit</button>
                            </div>
                        </form>
                        
                        <!-- Add this code below the form -->
                    <div class="text-center">
                      <a href="https://goldenvvipplatform.com/portal/login.php" class="login-link">Already have an account? Login here</a>
                    </div>
