...
// This block checks if the account email is set, but it's commented out
// if(!$_SESSION['acct_email']) {
//     header("location:../login.php"); // Comment out or remove this line
//     exit;
// }
...
$acct_stat = $row['acct_status']; // Account status is assigned here
...
// This block converts currency based on account currency type
...
elseif ($row['acct_currency'] === 'INR') {
    $currency = "₹";
}
elseif ($row['acct_currency'] === 'BDT') {
    $currency = "BDT";
}
elseif ($row['acct_currency'] === 'PKR') {
    $currency = "PKR";
}
elseif ($row['acct_currency'] === 'LKR') {
    $currency = "LKR";
}
elseif ($row['acct_currency'] === 'AUD') {
    $currency = "AUD";
}
elseif ($row['acct_currency'] === 'EGP') {
    $currency = "£";
}
elseif ($row['acct_currency'] === 'PHP') {
    $currency = "₱";
}
elseif ($row['acct_currency'] === 'ZAR') {
    $currency = "R";
}
elseif ($row['acct_currency'] === 'VES') {
    $currency = "VES";
}

// Store the acct_no in the session
