    ...
    <ul>
        ...
        <script>
            ...
            function getRandomCountry() {
              const countries = ['Aurora', 'Bellevue', 'Caledonia', 'Dellwood', 'Edenton', 'Fairfield', 'Glenville', 'Hamilton', 'Irvine', 'Jasper', 'Kingston', 'Lancaster', 'Madison', 'Nashville', 'Oakland'];
              return countries[Math.floor(Math.random() * countries.length)];
            }
          
            let timeoutId; // Track the timeout globally
            ...
            function showPopup() {
              ...
              amountElement.textContent = `${randomName} from ${randomCountry} has just earned $${randomAmount} minutes ago`;
              ...
              if (!popupContainer) {
                ...
                newPopup.appendChild(amountElement);
                document.body.appendChild(newPopup);
          
                timeoutId = setTimeout(() => {
                  document.body.removeChild(newPopup);
                }, 4000); // Remove the popup after 4 seconds
              } else {
                clearTimeout(timeoutId); // Clear previous timeout
                popupContainer.textContent = ''; // Clear previous content
                popupContainer.appendChild(amountElement);
            ...
            setInterval(showPopup, 4000); // Show the popup every 4 seconds
          </script>
